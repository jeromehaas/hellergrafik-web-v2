...
const SmallArrowLink = ({ className, children }) => {

	return (
		<a className={`${ className } small-arrow-link`}>
...
SmallArrowLink.propTypes = {
	className: PropTypes.string,
	children: PropTypes.node,
};

SmallArrowLink.defaultProps = {
	className: '',
};

export default SmallArrowLink;